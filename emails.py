...
conf = ConnectionConfig(
    MAIL_USERNAME = config_credentials["EMAIL_USER"],
    MAIL_PASSWORD = config_credentials["EMAIL_PASSWORD"],
    MAIL_FROM = config_credentials["EMAIL_HOST"],
    MAIL_PORT = 587,
...
async def send_email(email : EmailSchema, instance: User):
      ...
      template = f"""
        ...
        <body>
            <div style=" display: flex; align-items: center; justify-content: center; flex-direction: column;">
                ...
                <br>
                <p>Thanks for choosing Shiv Industries, please 
                ...
                <a style="margin-top:1rem; padding: 1rem; border-radius: 0.5rem; font-size: 1rem; text-decoration: none; background: #0275d8; color: white;"
                 href="http://localhost:8000/verification/?token= {token}">
                    Verify your email
                <a>
                <p style="margin-top:1rem;">If you did not register for Shiv Industries, 
    ...
    """
      ...
      message = MessageSchema(
        subject = "Shiv Industries Account Verification Mail",
